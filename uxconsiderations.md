...
*"¿Si un usuario llega a esto en 3 segundos, entiende qué hace el producto y quiere probarlo?"*
...
|---------------|-------------------|-------------|------------------------------------|
| H1 Hero       | `text-7xl/9xl`    | `font-black`| Primer impacto, debe ser memorable |
| H2 Sección    | `text-4xl/6xl`    | `font-black`| Ancla de cada sección              |
...
| Label/Badge   | `text-xs`         | `font-black`| UPPERCASE + `tracking-widest`      |
...
- **Error común:** Describir *qué hace* el sistema en lugar de *qué gana* el usuario.
...
| Testimonials con foto de perfil      | Avatar con inicial en `bg-lime-400` hasta tener fotos |
| Pricing con guarantee text           | "Cancelás cuando querés. Sin contratos."         |
| Footer con social links              | Ya implementado en `Layout.astro`                |

---

*Última actualización: Marzo 2026 — Landing Page v2.0 Refactor*
