...
@theme {
  /* Font families: Geist for all (neutral, geometric, accessibility-first) */
...
/* ────────────────────────────────────────────────────────────────────────────
   2. COLOR TOKENS (OKLCH - Perceptually Uniform)
   ──────────────────────────────────────────────────────────────────────────── */

:root {
  /* ── Primarios: Neutrales (Zinc Refinado) ──────────────────────────────── */
  --color-white: oklch(1 0 0);
  --color-black: oklch(0.145 0 0);
  
  /* ── Grises de Base (Zinc Palette) ──────────────────────────────────────── */
  ...
  /* ── Accent: Lime (Verde Energético - MiGym Brand) ──────────────────────── */
  --color-lime-400: oklch(0.865 0.19 144.978);
  --color-lime-500: oklch(0.822 0.191 145.026);
  --color-lime-600: oklch(0.745 0.166 144.798);
  
  /* ── Semánticos: Status Colors ──────────────────────────────────────────── */
  --color-success: oklch(0.577 0.245 27.325);    /* Green */
  --color-warning: oklch(0.688 0.206 48.305);   /* Orange */
  --color-error: oklch(0.577 0.245 27.325);     /* Red */
  --color-info: oklch(0.525 0.209 248.721);     /* Blue */
...
@theme inline {
  ...
  /* Semantic tokens para fácil referencia */
  --color-ui-label: var(--color-zinc-600);           /* Labels de UI */
  --color-ui-muted: var(--color-zinc-500);           /* Texto secundario */
  --color-ui-soft: var(--color-zinc-50);             /* Backgrounds suaves */
  --color-ui-accent: var(--color-lime-400);          /* Accent principal */
...
/* ────────────────────────────────────────────────────────────────────────────
   6. COMPONENT LAYER — Industrial Design System
   ──────────────────────────────────────────────────────────────────────────── */
...
@layer components {
  ...
  .industrial-label {
    @apply text-xs font-black uppercase tracking-widest text-muted-foreground;
  }

  .industrial-label-lg {
    @apply text-sm font-black uppercase tracking-wide text-foreground;
  }
  ...
  .industrial-title-lg {
    @apply text-3xl sm:text-4xl font-black tracking-tighter text-foreground uppercase;
  }
