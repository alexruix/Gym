  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        ...
        accent ? "bg-lime-500/10 text-lime-600 dark:text-lime-400 scale-110" : "text-zinc-400 group-hover:text-zinc-600 dark:group-hover:text-zinc-200"
      )}>
        <Icon className="w-5 h-5" aria-hidden="true" />
      </div>

      {/* Label (Detail Level) */}
      <span className="text-[10px] font-bold text-zinc-400 uppercase tracking-[0.15em] text-center leading-none">
        {label}
      </span>
