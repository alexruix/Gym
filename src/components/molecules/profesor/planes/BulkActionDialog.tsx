      ...
      <DialogContent className="max-w-[500px] bg-white dark:bg-zinc-950 p-0 rounded-[40px] border-none shadow-3xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-8 bg-zinc-950 text-white space-y-4">
           <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-[22px] bg-lime-400 flex items-center justify-center text-zinc-950">
        ...
        <div className="flex-1 overflow-y-auto p-8 space-y-8 custom-scrollbar">
           ...
           <div className="space-y-4">
              <div className="flex items-center justify-between px-1">
                 <span className="text-[10px] font-black uppercase tracking-[0.3em] text-zinc-400">Mapa del Mesociclo</span>
                 <Button 
                 ...
                 <div className="grid grid-cols-7 gap-2">
                    {DIAS_CORTOS.map((label, idx) => (
                        <button 
                            ...
                            className="text-[10px] font-black text-zinc-400 hover:text-lime-500 transition-colors uppercase tracking-widest h-8 flex items-center justify-center"
                        >
                            {label}
                        </button>
                    ))}
                    ...
                    return (
                        <div key={wNum} className="grid grid-cols-[60px_1fr] gap-3 group">
                            <button 
                                ...
                                className="text-[9px] font-black uppercase bg-zinc-50 dark:bg-zinc-900 text-zinc-400 hover:bg-zinc-950 hover:text-white transition-all rounded-xl h-12 flex items-center justify-center border border-zinc-100 dark:border-zinc-800"
                            >
                                Sem {wNum}
                            </button>
                                ...
                                {Array.from({ length: 7 }, (_, dIdx) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={cn(
                                                "h-12 rounded-xl border-2 transition-all flex items-center justify-center text-xs font-black relative overflow-hidden",
        ...
        <div className="p-8 bg-zinc-50 dark:bg-zinc-900 border-t border-zinc-100 dark:border-zinc-800 space-y-6">
           ...
           <div className="flex gap-4">
              <Button 
                ...
                className="flex-1 h-16 rounded-[24px] font-black uppercase text-[11px] tracking-[0.2em] text-zinc-400"
              >
                Cancelar
              </Button>
              <Button 
