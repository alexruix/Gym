          ...
          <div className="p-10 border-b border-zinc-100 dark:border-zinc-900 bg-zinc-50/30 dark:bg-zinc-900/10">
            <div className="flex items-center justify-between gap-4 mb-8">
                <div className="space-y-1">
                    <h2 className="text-3xl font-black text-zinc-950 dark:text-zinc-50 tracking-tight uppercase leading-none">
                ...
                <Button 
                    ...
                    className="rounded-xl px-5 text-[10px] font-black uppercase tracking-widest"
                >
                    {isCreating ? (
          ...
          <div className="max-h-[550px] overflow-y-auto p-10 custom-scrollbar bg-zinc-50/20 dark:bg-transparent">
            {isCreating ? (
                ...
                <div className="py-24 flex flex-col items-center justify-center space-y-4">
                    ...
                    <p className="text-[10px] font-black uppercase tracking-widest text-zinc-400">Accediendo a la biblioteca...</p>
                </div>
