...
export function StudentCompactCard({ student, onClick, href, customActions, className }: StudentCompactCardProps) {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 right-0 w-24 h-24 bg-lime-500/5 rounded-full -mr-12 -mt-12 transition-all group-hover:scale-150 duration-700" />
            ...
            <div className="flex flex-col gap-5 relative z-10 pointer-events-none">
                ...
                <div className="flex items-start justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <span className="block text-[10px] font-bold uppercase tracking-widest text-lime-600 dark:text-lime-400 opacity-80">
                ...
                <div className="pt-4 border-t border-zinc-100 dark:border-zinc-900 flex items-center justify-between">
                    <div className="flex items-center gap-1 text-[9px] font-bold uppercase tracking-widest text-zinc-400 group-hover:text-zinc-950 dark:group-hover:text-white transition-colors">
