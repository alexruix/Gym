        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90vw] max-w-sm bg-white dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-[2.5rem] shadow-2xl z-50 overflow-hidden p-8 animate-in zoom-in-95">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-bold uppercase tracking-tighter text-zinc-950 dark:text-white leading-none">
                {title}
              </h3>
              <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest">{copy.description}</p>
            ...
            <div className="grid gap-3">
              <Button
                ...
                className="h-14 rounded-2xl bg-zinc-100 dark:bg-zinc-900 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-950 dark:text-white font-bold uppercase text-[10px] tracking-widest transition-all p-4 flex flex-col items-center justify-center text-center gap-0.5"
              >
              ...
              <Button
                ...
                className={cn(
                  "h-14 rounded-2xl font-bold uppercase text-[10px] tracking-widest transition-all shadow-xl p-4 flex flex-col items-center justify-center text-center gap-0.5",
                  isRemove ? "bg-zinc-950 text-white" : "bg-lime-500 text-zinc-950"
                )}
              >
                <span className="flex items-center">
            ...
            <button onClick={onClose} className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest hover:text-zinc-600 transition-colors">
              {copy.cancel}
            </button>
          </div>
        </Dialog.Content>
