                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Button
                                    ...
                                    className="rounded-xl h-10 px-4 industrial-label border-zinc-200 dark:border-zinc-800 hover:border-lime-500 hover:text-lime-500 transition-all font-bold text-[10px]"
                                >
                            ...
                            <div className="space-y-3">
                                {fields.map((field, index) => (
                                    ...
                                    >
                                        <div className="industrial-icon-box-sm border border-zinc-200 dark:border-zinc-800 font-bold text-xs text-zinc-400 italic">
                                            {index + 1}
                                        </div>

                                        <div className="flex-1 min-w-0">
                                            <p className="font-bold text-sm text-zinc-950 dark:text-zinc-50 truncate uppercase tracking-tight">
                                            ...
                                            <div className="flex gap-4 mt-1">
                                                ...
                                                <div className="flex items-center gap-1.5 grayscale opacity-50 group-hover:grayscale-0 group-hover:opacity-100 transition-all">
                                                    ...
                                                    <input
                                                        ...
                                                        className="w-12 bg-transparent border-none p-0 text-[10px] font-bold text-lime-600 focus:ring-0"
                                                    />
                                                </div>
                                            </div>
                                        </div>
                        ...
                        >
                            {isPending ? (
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="text-sm font-bold uppercase tracking-tight">Crear Bloque</span>
                                </div>
                            )}
                        </Button>
                    </div>
