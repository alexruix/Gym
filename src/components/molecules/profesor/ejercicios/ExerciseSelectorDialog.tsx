                  ...
                  {filteredVariants.length > 0 && (
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 px-1 mb-3">
                            ...
                            <span className="text-[8px] font-black uppercase tracking-[0.2em] text-fuchsia-500 underline decoration-fuchsia-500/30 underline-offset-4">Variantes sugeridas</span>
                        </div>
                    ...
                    <div className="space-y-2">
                        {filteredVariants.length > 0 && (
                            <div className="flex items-center gap-2 px-1 mt-4 mb-3">
                                <span className="text-[8px] font-black uppercase tracking-[0.2em] text-zinc-500">Otros ejercicios</span>
                            </div>
                        )}
                        {filtered.map(ex => (
        ...
        <button
          ...
          className={cn(
            ...
            isVariant 
                ...
                : "bg-zinc-50 dark:bg-zinc-900/50 border-transparent hover:border-lime-400/30 hover:bg-lime-400/5"
          )}
        >
          <div className={cn(
          ...
          <div className="flex flex-col">
              ...
              {isVariant && <span className="text-[7px] font-black uppercase tracking-widest text-fuchsia-500 mt-0.5">Sustitución rápida</span>}
          </div>
          <Check className={cn(
