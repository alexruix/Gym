  ...
  return (
    <div className={cn("inline-flex items-stretch rounded-2xl overflow-hidden shadow-xl shadow-zinc-950/20 active:scale-[0.98] transition-all duration-300", className)}>
      ...
      >
        ...
        <span className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] py-4">
          {createLabel}
        </span>
      </a>
      ...
      <DropdownMenu>
        ...
        >
          <DropdownMenuItem asChild>
            ...
            >
                <div className="p-2 bg-zinc-100 dark:bg-zinc-900 rounded-lg group-hover:bg-lime-400 group-hover:text-zinc-950 transition-colors">
                    <FileSpreadsheet className="w-4 h-4" />
                </div>
                <div className="flex flex-col">
                    <span className="text-sm font-bold text-zinc-900 dark:text-zinc-100">{importLabel}</span>
                    <span className="text-[9px] font-black uppercase tracking-widest text-zinc-500">Formato Excel / CSV</span>
                </div>
            </a>
          </DropdownMenuItem>
        </DropdownMenuContent>
