    ...
    <DropdownMenu>
      ...
      >
        <div className="px-5 py-4 flex items-center justify-between border-b bg-zinc-50/50 dark:bg-zinc-900/50">
          <DropdownMenuLabel className="p-0 font-bold uppercase tracking-widest text-[10px] text-zinc-400">
          ...
          {unreadCount > 0 && (
            <button
              ...
              className="text-[10px] font-bold uppercase tracking-widest text-lime-500 hover:text-lime-600 transition-colors flex items-center gap-1 cursor-pointer"
            >
        ...
        <DropdownMenuItem
          className="p-4 flex justify-center text-[10px] font-bold uppercase tracking-widest text-zinc-400 hover:text-zinc-900 transition-colors cursor-pointer"
