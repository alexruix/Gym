    ...
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="bg-white border-zinc-200 w-full sm:max-w-md overflow-y-auto">
        <SheetHeader className="mb-6">
          <SheetTitle className="text-2xl font-bold text-zinc-900 uppercase tracking-tighter">
            Gestión de turnos
          </SheetTitle>
        ...
        <div className="space-y-6">
          <div className="space-y-4">
            <Button
              ...
              className={cn(
                "w-full h-12 bg-zinc-50 border-zinc-200 rounded-2xl text-[10px] font-bold uppercase tracking-widest transition-all group",
                editingId === "new" ? "opacity-30" : "hover:bg-lime-500 hover:text-zinc-950"
              )}
            >
          ...
          {!editingId && turnos.length === 0 && (
            <div className="space-y-4 animate-in fade-in slide-in-from-top-4 duration-500">
              <div className="flex items-center gap-4 px-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-400">O usá una plantilla</span>
                <Separator className="flex-1 bg-zinc-100" />
              </div>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className={cn("w-1 h-8 rounded-full bg-zinc-100 group-hover:bg-lime-500 transition-colors")} />
                    <div>
                      ...
                      <div className="flex items-center gap-3 mt-1">
                        ...
                        <span className="text-[10px] font-bold text-lime-600 uppercase tracking-widest border-l border-zinc-100 pl-3">
