  ...
  return (
    ...
    >
      <div className={cn(
        ...
        isActive ? "bg-lime-400" : "bg-zinc-100 dark:bg-zinc-800"
      )} />

      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-baseline gap-3">
              <span className="text-2xl md:text-3xl font-black text-zinc-900 dark:text-zinc-50 uppercase tracking-tighter">
