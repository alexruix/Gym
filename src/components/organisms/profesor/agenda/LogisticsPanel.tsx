                ...
                <div className="p-8 pb-4">
                    <DialogHeader className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <DialogTitle className="text-2xl font-bold uppercase tracking-tighter text-zinc-900 leading-none">
                                    {copy.title}
                                </DialogTitle>
                ...
                <div className="h-[350px] overflow-y-auto px-8 custom-scrollbar">
                    <div className="flex items-center justify-between py-4 border-b border-zinc-100 sticky top-0 bg-white z-10">
                        ...
                        <Button
                            ...
                            className="h-8 rounded-xl text-[10px] font-bold uppercase tracking-widest text-zinc-500 hover:bg-zinc-100"
                        >
                                ...
                                >
                                    <div className="flex items-center gap-4 flex-1 cursor-pointer" onClick={() => toggleStudent(student.id)}>
                                        <Checkbox
                                            ...
                                            className="h-5 w-5 rounded-md border-zinc-200 data-[state=checked]:bg-lime-500 data-[state=checked]:border-lime-400"
                                        />
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-0.5">
                                                {currentTurno ? (
                                                    ...
                                                    <span className="text-[9px] font-bold uppercase tracking-widest text-lime-600 flex items-center gap-1">
                                    ...
                                    {onEditStudent && (
                                        <Button
                                            ...
                                            className="opacity-0 group-hover/row:opacity-100 transition-opacity h-8 px-4 rounded-xl border border-zinc-200 hover:border-lime-400 hover:bg-lime-50 text-[10px] font-bold uppercase tracking-widest text-zinc-600 hover:text-lime-600 focus:opacity-100"
                                        >
                                            Editar
                                        </Button>
                                    )}
                ...
                <div className="p-8 bg-zinc-50 border-t border-zinc-100 space-y-6">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 ml-1">{copy.selectTurno}</label>
                        ...
                        <div className="space-y-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-zinc-500 ml-1">{copy.selectDays}</label>
                            ...
                            <div className="flex flex-wrap gap-2 mt-2">
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className="rounded-xl font-bold text-[9px] uppercase tracking-widest h-8 border-zinc-100 dark:border-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
                    ...
                    <Button
                        ...
                        className="w-full h-16 rounded-[1.5rem] bg-lime-500 text-zinc-950 hover:bg-lime-500 shadow-lg shadow-lime-400/10 transition-all font-bold uppercase tracking-widest active:scale-[0.98]"
                    >
                        {isPending ? (
