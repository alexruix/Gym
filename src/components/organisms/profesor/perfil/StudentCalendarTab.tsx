      ...
      {hasOmissions && (
         <div className="bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-3xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 animate-in slide-in-from-top-2">
            ...
            <Button 
                ...
                className="bg-zinc-950 hover:bg-zinc-800 text-white font-black uppercase text-[10px] tracking-widest h-12 px-8 rounded-2xl shadow-xl transition-all active:scale-95 border border-zinc-800"
            >
