                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm min-w-[500px] sm:min-w-0">
                      <thead className="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-800">
                        <tr>
                          <th className="px-4 py-3 text-left font-bold uppercase tracking-widest text-[9px] text-zinc-500">{copy.columns.name}</th>
                          <th className="px-4 py-3 text-left font-bold uppercase tracking-widest text-[9px] text-zinc-500">{copy.columns.email}</th>
                          <th className="px-4 py-3 text-left font-bold uppercase tracking-widest text-[9px] text-zinc-500">{copy.columns.phone}</th>
                        </tr>
                      </thead>
