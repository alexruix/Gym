    ...
    <div className="flex flex-col gap-6 max-w-lg mx-auto w-full pb-32 font-sans">
      ...
      {sesionBase && sesionBase.length > 0 ? sesionBase.map((ej, idx) => {
        ...
        return (
          <div 
            key={ej.ejercicio_id} 
            className={`rounded-2xl border bg-zinc-900/60 backdrop-blur-md transition-all duration-300 ${
              isActive ? 'border-lime-500 shadow-[0_0_15px_rgba(163,230,53,0.15)] ring-1 ring-lime-500' : 'border-zinc-800'
            } overflow-hidden`}
          >
            ...
            >
              <div className="flex flex-col items-center">
                <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-xl transition-all ${
                  isDone ? 'bg-lime-500 text-black scale-95' : isActive ? 'bg-lime-500 text-black' : 'bg-zinc-800 text-white'
                }`}>
              ...
              <div className="px-5 pb-5 pl-20 animate-in slide-in-from-top-4 duration-300">
                ...
                {isCommenting === ej.ejercicio_id && (
                  <div className="mb-6 p-4 bg-zinc-950 rounded-xl border border-zinc-800/50">
                    ...
                    <div className="flex justify-end gap-3 mt-3">
                      ...
                      <button onClick={() => submitComment(ej.ejercicio_id)} className="bg-white hover:bg-lime-400 text-black text-xs font-black px-4 py-2 uppercase tracking-wide rounded-md transition-colors">Guardar Nota</button>
                    </div>
                  </div>
                )}
                ...
                <div className="flex gap-3">
                  ...
                  <button 
                    ...
                    className="flex-1 bg-lime-500 hover:bg-lime-400 text-black font-black uppercase tracking-widest text-lg rounded-xl flex items-center justify-center gap-2 shadow-[0_4px_14px_0_rgba(163,230,53,0.39)] hover:shadow-[0_6px_20px_rgba(163,230,53,0.23)] transition-all active:scale-95"
                  >
                    âœ” Marcar Listo
                  </button>
                </div>
