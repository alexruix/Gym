  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekdays: "flex",
        weekday: "text-zinc-500 rounded-md w-9 font-bold text-[10px] uppercase tracking-tighter text-center",
        week: "flex w-full mt-2",
        day: "h-9 w-9 text-center text-sm p-0 relative focus-within:relative focus-within:z-20",
        day_button: cn(
          buttonVariants({ variant: "ghost" }),
          "h-9 w-9 p-0 font-medium aria-selected:opacity-100 rounded-xl hover:bg-lime-500 hover:text-zinc-900 transition-all duration-300"
        ),
        range_start: "day-range-start",
        range_end: "day-range-end",
        selected:
          "bg-lime-500 text-zinc-900 hover:bg-lime-500 hover:text-zinc-900 focus:bg-lime-500 focus:text-zinc-900 font-bold shadow-[0_0_15px_rgba(163,230,53,0.3)] !opacity-100",
        ...
        dropdown: "appearance-none bg-transparent border-none text-[11px] font-bold uppercase tracking-widest text-zinc-900 dark:text-zinc-100 focus:outline-none cursor-pointer hover:text-lime-500 transition-colors px-1",
